...
class CRC16_DDS_110
{
    ...
    {
        $CRC_16_DDS_110_ = new CrcParams();
        $CRC_16_DDS_110_->Init = 0x800D;
        $CRC_16_DDS_110_->Name = "CRC-16/DDS-110";
        $CRC_16_DDS_110_->XorOut = 0x0;
        $CRC_16_DDS_110_->RefOut = FALSE;

        $CRC_16_DDS_110_->Poly = 0x8005;
        $CRC_16_DDS_110_->RefIn = FALSE;
        $CRC_16_DDS_110_->Check = 0x9ECF;
        $CRC_16_DDS_110_->Array = array(0x0000, 0x8005, 0x800F, 0x000A, 0x801B, 0x001E,
