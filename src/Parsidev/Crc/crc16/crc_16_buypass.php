...
class CRC16_BUYPASS
{
    ...
    {
        $CRC_16_BUYPASS_ = new CrcParams();
        $CRC_16_BUYPASS_->Init = 0x0;
        $CRC_16_BUYPASS_->Name = "CRC-16/BUYPASS";
        $CRC_16_BUYPASS_->XorOut = 0x0;
        $CRC_16_BUYPASS_->RefOut = FALSE;

        $CRC_16_BUYPASS_->Poly = 0x8005;
        $CRC_16_BUYPASS_->RefIn = FALSE;
        $CRC_16_BUYPASS_->Check = 0xFEE8;
        $CRC_16_BUYPASS_->Array = array(0x0000, 0x8005, 0x800F, 0x000A, 0x801B, 0x001E,
